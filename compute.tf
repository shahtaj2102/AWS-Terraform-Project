...
# Pulls the real PrintFlow dashboard (index.html, styles.css,
# script.js) straight from its public GitHub repo at boot time,
# rather than a hardcoded placeholder page. Note: this only runs
# once at first boot - instances already running won't re-fetch
# automatically if the files change on GitHub later.
user_data = base64encode(<<-EOF
#!/bin/bash
dnf install -y httpd
curl -o /var/www/html/index.html https://raw.githubusercontent.com/shahtaj2102/web-app-on-digitalocean/main/index.html
curl -o /var/www/html/styles.css https://raw.githubusercontent.com/shahtaj2102/web-app-on-digitalocean/main/styles.css
curl -o /var/www/html/script.js https://raw.githubusercontent.com/shahtaj2102/web-app-on-digitalocean/main/script.js
